...
<div class="main">
    ...
    <div class="modal">
        <div class="modal__content">
            ...
            <h1 class="modal__title">Добавить пользователя</h1>
            <form action = "${pageContext.request.contextPath}/clients" method="post">
                ...
                <br />
                Last Name: <input type = "text" name = "secondName" autocomplete="off"/>
                <br/>
        ...
        <div class="modal__content1">
            ...
            <form>
                <fieldset>
                    ...
                    <label>Имя<input type="text" name="firstName" required autocomplete="off"></label>
                    <label>Фамилия<input required autocomplete="off" name="secondName"></label>
    ...
    <div class="modal2">
        <div class="modal__content2">
            ...
            <!-- Контент модального окна -->
            <h1 class="modal__title2">Удалить данные о пользователе</h1>
            <form>
                <fieldset>
                    <legend>Данные</legend>
                    ID:  <input type = "text" name = "id" autocomplete="off"/>
